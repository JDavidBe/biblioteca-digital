...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/usuarios").permitAll()                .anyRequest().authenticated()
            )
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("https://biblioteca-digital-uhyg.onrender.com", "http://localhost:3000", "http://localhost:5173"));
