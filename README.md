...
| ms-notificaciones   | 8086   | Envío de notificaciones por email        |
...
# (Opcional) Configurar email para notificaciones
cp .env.example .env
# editar MAIL_USERNAME y MAIL_PASSWORD en .env
...
**Total de pruebas:** 251 tests distribuidos en 7 microservicios.
